...
li a:hover {
  ...
  <body>
    ...
    <ul>
      <li><a class="active" href="$user">الحساب الشخصي</a></li>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <img src="images_posts/<?php echo $row['Image']; ?>" width="320px" height="320px"  title="<?php echo $row['Image']; ?>">
...
<footer class="text-muted py-3">
  <div class="container">
    <p class="float-end mb-1">
      <a href="dashboard1.php">عد إلى الأعلى</a>
    </p>
